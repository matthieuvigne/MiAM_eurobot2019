...
int main( ){
    ...
    waypoint_list.push_back(miam::RobotPosition(250.0, 100.0, 0.5));
    waypoint_list.push_back(miam::RobotPosition(400.0, 125.0, 0.5));
    waypoint_list.push_back(miam::RobotPosition(500.0, 200.0, 1.0));
    ...
    waypoint_list_2.push_back(miam::RobotPosition(500.0, 200.0, 1.0));
    waypoint_list_2.push_back(miam::RobotPosition(600.0, 275.0, 0.5));
    waypoint_list_2.push_back(miam::RobotPosition(750.0, 300.0, 0.5));
    waypoint_list_2.push_back(miam::RobotPosition(1000.0, 400.0, 0.0));
