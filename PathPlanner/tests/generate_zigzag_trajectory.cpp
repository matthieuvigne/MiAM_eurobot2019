...
int main( ){
    ...
    last_trajectory_point.linearVelocity = 300.0;
    ...
    miam::trajectory::TrajectoryPoint tp_first_half =
        sampled_trajectory.getEndPoint();
    ...
    first_trajectory_point_2.linearVelocity = tp_first_half.linearVelocity;
    first_trajectory_point_2.angularVelocity = tp_first_half.angularVelocity;
